...
let chap16 = [["the parents", 	 "les parents"],
    ...
    ["family life", "la vie de famille, la vie familiale"],
    ["a close family / a close-knit family", "une famille très unie"],
    ["to start a family", "fonder un foyer"],
    ["upbringing / parenting", "l’éducation des enfants"],
    ["parental leave", "le congé parental"],
    ["the generation gap", "le conflit des générations"],
    ["to bring up / (us) to raise a child", "élever un enfant"],
    ["the break-up of the family unit", "la rupture de la cellule familiale"],
    ["a single-parent family / a one-parent family", "une famille monoparentale"],
    ["a blended family", "une famille recomposée"],
    ["same-sex parents", "une famille homoparentale"],
    ["an unmarried mother", "une mère célibataire"],
    ["surrogacy", "la GPA (la gestation pour autrui)"],
    ["a surrogate mother", "une mère porteuse"],
    ["to get engaged", "se fiancer"],
    ["marriage", "le mariage (l’institution)"],
    ["to go to a wedding", "aller à un mariage"],
    ["to get married to sb / to marry sb", "épouser qn"],
    ["to be married to sb", "être marié à qn"],
    ["to be single", "être célibataire"],
    ["married life", "la vie conjugale"],
    ["to get on / to get along well with sb", "bien s’entendre avec qn"],
    ["to live together / to cohabit", "vivre en concubinage"],
    ["cohabitation", "l’union libre, le concubinage"],
    ["to be in a relationship", "avoir qn dans sa vie"],
    ["a common-law husband / wife", "un concubin / une concubine"],
    ["a partner", "un compagnon, une compagne"],
    ["civil partnership", "l’union civile (GB), le PACS (Fr)"],
    ["same-sex marriage / gay marriage", "le mariage homosexuel, pour tous"],
    ["to break up / to split up (with sb)", "rompre (avec qn)"],
    ["divorce / to (get a) divorce", "le divorce / divorcer"],
    ["to have custody of the children", "avoir la garde des enfants"],
    ["to pay alimony", "verser une pension alimentaire"],
    ["a couple", "un couple"],
    ["Many people do not see the point in tying the knot and prefer to cohabit", "Beaucoup de gens ne voient pas l’intérêt de se marier et préfèrent vivre en concubinage"],
    ["the children are bound to benefit from it", "les enfants ne peuvent qu’en bénéficier"],
    ["when they need a shoulder to cry on", "quand ils ont besoin d'être réconfortés"],
    ["broken homes", "les familles désunis"],
    ["few and far", "de moins en moins fréquentes"],
    ["single-child families", "les familles avec un seul enfant"],
    ["be able to bring up properly", "être capable d'élever correctement"],
    ["Among the often-cited reasons for divorce are : unfaithfulness", "Parmi les raisons souvent invoquées pour expliquer le divorce, on trouve : l’infidélité"]]

let chap17 = [["the depopulation crisis", "la dénatalité, la crise de la natalité"],
["the fall in the birth rate", "la diminution des naissances"],
["a demographic crisis", "une crise démographique"],
["an unprecedented decline", "une baisse sans précédent"],
["to fall by / to shrink by (5%)", "baisser de, diminuer de (5 %)"],
["a fall in / a decrease in the population", "une diminution de la population"],
["to fall sharply", "diminuer fortement"],
["to collapse / to slump", "s’effondrer"],
["to plummet / to plunge", "être en chute libre"],
["a baby bust", "une chute de la natalité"],
["a birth dearth", "un nombre de naissances insuffisant"],
["the generation replacement rate", "le taux de remplacement des générations"],
["an ageing population", "une population vieillissante"],
["to delay giving birth", "avoir des enfants plus tard"],
["to pursue higher education", "faire des études supérieures"],
["to opt against giving birth", "décider de ne pas avoir d’enfants"],
["to be reluctant to have children", "hésiter à avoir des enfants"],
["to live for oneself", "vivre pour soi"],
["effective contraceptive devices", "des moyens de contraception efficaces"],
["to be incompatible with a career", "être incompatible avec une carrière"],
["the fear of unemployment / the future", "la peur du chômage / de l’avenir"],
["prohibitive housing costs", "des coûts du logement prohibitifs"],
["to address the crisis", "s’attaquer à la crise"],
["a strong birth policy", "une politique nataliste volontariste"],
["to urge / to encourage people to have more children", "inciter les gens à avoir plus d’enfants"],
["to take measures / steps", "prendre des mesures"],
["incentives", "des mesures incitatives"],
["to promote flexitime", "promouvoir l’aménagement du temps de travail"],
["to promote long-term employment", "promouvoir l’emploi pérenne"],
["early schooling", "la scolarisation précoce"],
["to set up childcare facilities", "bâtir des crèches"],
["tax breaks", "des réductions d’impôts"],
["extend maternity / paternity leave", "allonger les congés de maternité / de paternité"],
["to increase child benefit", "augmenter les allocations familiales"],
["maternity benefits / maternity pay", "les allocations (de) maternité"],
["to grow old", "vieillir"],
["Ever since the advent of the pill", "Depuis l’avènement de la pilule"],
["rather than", "plutôt que"],
["through immigration", "en raison de l’immigration"],
["to roughly", "à peu près"],
["it should be the other way round", "ce devrait être l’inverse"],
["least developed countries", "les pays les moins avancés"],
["nowhere", "nulle part"],
["voluntary childlessness", "le fait de ne pas avoir d’enfants par choix"]]

let chap18 =[["a crime", "un délit"],	
    ["crime / criminality", "les délits / la criminalité"],
    ["the crime rate", "le taux de criminalité"],
    ["urban violence", "la violence urbaine"],
    ["(juvenile) delinquency", "la délinquance (juvénile)"],
    ["a (teenage) delinquent", "un (jeune) délinquant"],
    ["a yob / a yobbo / a thug", "un voyou, un loubard"],
    ["verbal abuse", "la violence verbale"],
    ["aggressiveness", "l'agressivité"],
    ["a law-breaker / a criminal", "qn qui transgresse la loi"],
    ["to break the law", "transgresser la loi"],
    ["a murder", "un meutre"],
    ["violent crime", "les délits avec violence"],
    ["knife crime", "les attaques au couteau"],
    ["organized crime", "le crime organisé, grand banditisme"],
    ["white-collar crime", "les délits financiers"],
    ["tax evasion / a tax dodger", "la fraude fiscale / un fraudeur de fisc"],
    ["embezzlement", "le détournement de fonds"],
    ["insider dealing / insider trading", "le délit d'initiés"],
    ["money laundering", "le blanchiment d'argent"],
    ["counterfeiting", "la contrefaçon"],
    ["cybercrime", "la cybercriminalité"],
    ["a credit card scam", "une arnaque à la carte de crédit"],
    ["petty crime", "la petite délinquance"],
    ["to turn to crime", "basculer dans la criminalité"],
    ["to commit a murder / a crime", "commettre un meutre / un délit"],
    ["a mugging", "une attaque avec violence"],
    ["to attack sb / assault sb / mug sb", "attaquer qn, agresser qn"],
    ["armed robbery", "le vol à main armé"],
    ["burglary / a burglar", "cambriolage / un cambrioleur"],
    ["to burgle / (US) to burglarize", "cambrioler (une maison)"],
    ["to break into a place / to raid a bank", "s'introduire par effraction quelque part / braquer une banque"],
    ["shoplifting", "le vol à l'étalage"],
    ["to steal sth from sb", "voler qch à qn"],
    ["a theft / a thief", "un vol / un voleur"],
    ["racketeering / a racketeer", "le racket / un racketteur"],
    ["to extort money from sb", "racketter qn"],
    ["a riot / a rioter", "une émeute / un casseur"],
    ["vandalism / to vandalize", "le vandalisme / vandaliser"],
    ["crimes figures", "les chiffres de la criminalité"],
    ["ought to be touger on delinquency", "devrait être plus sévère à l'égard de la délinquance"],
    ["but this is mainly due to", "mais cela est dû principalement à"],
    ["to stop at nothing", "ne reculer devant rien"],
    ["to ressort to carjacking", "avoir recours au carjacking"],
    ["to ram-raiding to burgle shops", "attaques à la voiture-bélier pour dévaliser des magasins"],
    ["trouble spots", "les zones à risque"],
    ["no go areas", "les zones de non-droit"],
    ["drugtrafficking", "le trafic de drogue"],
    ["gangkillings", "les règlements de compte entre gangs"],
    ["to be craked down on hard", "être réprimé sévèrement"],
